    ...
    <div class="interface">
      ...
      <form method="post" id="fContato" action="{{ route('cadastrar_reserva') }}" oninput="calc_total();">
        ...
        <fieldset id="apto">
          ...
          <p>
            <label for="cDorm">Apartamento:</label>
            <select name="dormitorios" id="cApto">
              <option selected>Selecione</option>
        ...
        <fieldset>
          ...
          <p>
            <label for="cDiar">Diárias:</label> 
            <input type="number" name="diarias" id="cDiar" readonly>
          </p>
          <p>
            <label for="cValorDiar">Valor da diária:</label> 
            <input type="text" name="valor_diaria" id="cValorDiar" maxlength="40" size="20" placeholder="R$">
          </p>
          <p>
            <label for="cValorLim">Valor da limpeza:</label> 
            <input type="text" name="valor_limpeza" id="cValorLim" maxlength="40" size="20" placeholder="R$">
          </p>
        </fieldset>
