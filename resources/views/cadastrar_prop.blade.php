      ...
      <form method="post" id="fContato" action="{{ route('cadastrar_prop_ap') }}">
        ...
        <fieldset id="usuario">
          ...
          <p>
            ...
            <input type="CPF" name="cpf" id="cCPF" placeholder="000.000.000-00">
          </p>
          <p>
            <label for="cRua">Endereço: </label> 
            <input type="text" name="endereco" id="cRua" size="15" maxlength="80" placeholder="Rua, Cidade, Estado">
          </p>
          <p>
            <label for="cTel">Telefone: </label>
            <input type="phone" name="telefone" id="cTel" placeholder="(00) 90000-0000">
          </p>
          <p>
            <label for="cMail">E-mail: </label> 
            <input type="email" name="email" id="cMail" size="20" maxlength="40" placeholder="Email">
          </p>
        ...
        <fieldset>
          ...
          <p> 
            ...
            <input type="text" name="banco" id="cbanco" size="20" maxlength="30" placeholder="Digite seu banco">
          </p>
          <p> 
            <label for="cAgencia">N° da Agência: </label> 
            <input type="number" name="agencia" id="cAgencia" size="20" maxlength="30" placeholder="Digite sua agência">
          </p>
          <p> 
            <label for="cConta">N° da Conta: </label> 
            <input type="number" name="conta" id="cConta" size="20" maxlength="30" placeholder="Digite sua conta">
          </p>
          <p> 
            <label for="cTipo_conta">Tipo da Conta: </label> 
            <input type="text" name="tipo_conta" id="cTipo_Conta" size="20" maxlength="30" placeholder="Digite seu tipo de conta">
          </p>
